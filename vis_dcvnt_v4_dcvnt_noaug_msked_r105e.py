...
#
#
# src = 'dataset4/NCOV-BF/NpyData-size224x336-test2'
#
# def create_masked_lungs(x):
#     print(x)
#     print('make masks')
#     raw_imgs = np.load(os.path.join(src, x+'.npy'))
#     raw_masks = np.load(os.path.join(src, x+'-dlmask.npy'))
#
#     length = len(raw_imgs)
#
#     raw_infmasked10 = np.zeros((length, 224, 336))
#     # raw_infmasked10 = np.zeros((length, 512,512))
#
#     for i in range(length):
#         # mask the images
#
#         raw_infmasked10[i] = cv2.bitwise_and(raw_imgs[i], raw_imgs[i], mask=raw_masks[i].astype('uint8'))
#
#
#     np.save(os.path.join(src, x+"-infmask.npy"), raw_infmasked10)
#
...
class CTDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        data_path = data_path.replace('.npy', '-infmask.npy') # this should mean now use masks
...
model.load_state_dict(torch.load('experiments_v4_dcvnt_msk2/ncov-Epoch_00105.pth'))
...
SNAPSHOT_FREQ = 5
TRAIN_EPOCH = 100 #, will likely stop it early
SNAPSHOT_HOME = "experiments_v4_dcvnt_msk2_r105"
