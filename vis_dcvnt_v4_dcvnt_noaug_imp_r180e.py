...
run = neptune.init(
    project="asdasdasd/res-project",
    api_token="eyJhcGlfYWRkcmVzcyI6Imh0dHBzOi8vYXBwLm5lcHR1bmUuYWkiLCJhcGlfdXJsIjoiaHR0cHM6Ly9hcHAubmVwdHVuZS5haSIsImFwaV9rZXkiOiJiNTVlNGI3Zi04ZWRiLTQ2MWYtYTFlYy1jNWI4YjA3Y2FkNzkifQ==",
)  # your credentials
...
model.load_state_dict(torch.load('experiments_v4_dcvnt_imp_run2_r160/ncov-Epoch_00180.pth'))
...
SNAPSHOT_FREQ = 5
TRAIN_EPOCH = 21 #, will likely stop it early
SNAPSHOT_HOME = "experiments_v4_dcvnt_imp_run2_r180"
