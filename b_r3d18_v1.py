...
r3d18_1.load_state_dict(torch.load(PATH)['state_dict'])
r3d18_1.eval()
r3d18_1 = r3d18_1.to(device)

# so we're doing feature extraction
for p in r3d18_1.parameters():
    p.requires_grad = False

# change to classify for 2 classes
r3d18_1.fc = nn.Linear(r3d18_1.fc.in_features, 2).to(device) # 2 classes
...
print('Model outputs for b_r3d18_1:')
...
torch.save(r3d18_1.state_dict(), 'b_r3d18_1.pth')
...
# Model class must be defined somewhere
r3d18_2.load_state_dict(torch.load(PATH)['state_dict'])
r3d18_2.eval()
r3d18_2 = r3d18_2.to(device)

# so we're doing feature extraction
for p in r3d18_2.parameters():
    p.requires_grad = False

# change to classify for 2 classes
r3d18_2.fc = nn.Linear(r3d18_2.fc.in_features, 2).to(device) # 2 classes
...
optimizer = optim.SGD(r3d18_2.parameters(), lr=0.001, momentum=0.9)
...
print('Model outputs for b_r3d18_2:')
...
torch.save(r3d18_2.state_dict(), 'b_r3d18_2.pth')
...
print('Model outputs for b_r3d18_T:')
