...
save_path = 'dataset4/NCOV-BF/NpyData-infmask-test/'
model = Inf_Net()
...
des_home = 'dataset4/NCOV-BF/NpyData-infmask-test' # '/content/test'
...
des_home = 'dataset4/NCOV-BF/NpyData-size224x336-infmask1010-test'
