...
model.load_state_dict(torch.load('experiments_v4_dcvnt_run2/ncov-Epoch_00140.pth'))
...
SNAPSHOT_FREQ = 5
TRAIN_EPOCH = 65 #, will likely stop it early
SNAPSHOT_HOME = "experiments_v4_dcvnt_run2_r140"
