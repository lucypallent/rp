...
save_path = 'dataset4/NCOV-BF/NpyData-infmask'
model = Inf_Net()
...
des_home = 'dataset4/NCOV-BF/NpyData-infmask' # '/content/test'
src_home = 'dataset3/NCOV-BF/NpyData' # '/content' # where lung masks are saved 'unet-results'
