...
def test_model(model_pth, folder_pth, run, model_covcap_pth):
    ...
    model_covcap = ENModel(arch=ARCH, resnet_depth=DEPTH,
                        input_channel=2,
                        crop_h=TRAIN_CROP_SIZE[0],
                        crop_w=TRAIN_CROP_SIZE[1], num_classes=NUM_CLASSES)
...
def main(argv):
    ...
    model_covcap_folder = 'experiments_v4_dcvnt_cvcp_run2' # sys.argv[3]
    ...
    # for m in model_lst:
    m = 'experiments_v4_dcvnt_run2_r140/ncov-Epoch_00200.pth'
