...
model.load_state_dict(torch.load('experiments_v4_dcvnt_noaug_infmask1010_t2_1pc_pnm_ft/ncov-Epoch_00045.pth'))
...
WEIGHT_DECAY = 0
LR_DECAY = 1
INIT_MODEL_PATH = 'experiments_v4_dcvnt_noaug_infmask1010_t2_1pc_pnm_ft/ncov-Epoch_00045.pth'
INIT_MODEL_STRICT = "True"
SNAPSHOT_FREQ = 5
TRAIN_EPOCH = 200 #, will likely stop it early
SNAPSHOT_HOME = "experiments_v4_dcvnt_noaug_infmask1010_t2_1pc_pnm_ft_res45"
