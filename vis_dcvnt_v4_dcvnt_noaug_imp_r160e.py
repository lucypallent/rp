...
model.load_state_dict(torch.load('experiments_v4_dcvnt_imp_run2/ncov-Epoch_00160.pth'))
...
SNAPSHOT_FREQ = 5
TRAIN_EPOCH = 41 #, will likely stop it early
SNAPSHOT_HOME = "experiments_v4_dcvnt_imp_run2_r160"
