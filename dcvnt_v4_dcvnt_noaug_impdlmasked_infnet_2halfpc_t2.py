...
class CTDataset(data.Dataset):
    def __init__(self, data_home="",
        ...
        meta_pos   = [[os.path.join(data_home, "NpyData-size224x336-infmask1010-test-2halfpc", "{}.npy".format(x)), 1]
                                for x in readvdnames(_embo_f)]

        meta_neg   = [[os.path.join(data_home, "NpyData-size224x336-infmask1010-test-2halfpc", "{}.npy".format(x)), 0]
                                for x in readvdnames(_norm_f)]

        meta_cap   = [[os.path.join(data_home, "NpyData-size224x336-infmask1010-test-2halfpc", "{}.npy".format(x)), 2]
...
SNAPSHOT_HOME = "experiments_v4_dcvnt_noaug_infmask1010_t2_2halfpc"
