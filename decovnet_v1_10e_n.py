# this version classes three different classes
...
P_lst = all_df.loc[all_df['diag_num']==2, 'Patient ID'].drop_duplicates().to_list()

p = transforms.Compose([transforms.Resize(512)])
clss = '/1NonCOVID/'
for pi in N_lst:
...
class CTDataset(data.Dataset):
    def __init__(self, data_home="",
        ...
        # NCOV-BF/ImageSets/lung_test.txt
...
# move the npydata and npymask to 'NCOV-BF/NpyData-size224x336',
# move the list file to 'NCOV-BF/ImageSets'
...
pe_list = readvdnames(f"NCOV-BF/ImageSets-old/lung_test.txt")[::-1]
...
run["config/dataset/path"] = 'NCOV-BF'
