...
for pi in N_lst:
    ...
    if not(os.path.exists('dataset3/NCOV-BF/NpyData/')):

        # create the directory you want to save to
        os.mkdir('dataset3/NCOV-BF/NpyData/')
...
# write_txt('dataset3/NCOV-BF/ImageSets/lung_test.txt', N_lst_train, C_lst_train, P_lst_train)
...
DATA_ROOT = 'dataset3/dataset3/-BF'
