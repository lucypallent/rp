# generate r3d34 based on here https://github.com/kenshohara/3D-ResNets-PyTorch/blob/master/models/resnet.py
...
# using the model that was trained 10 times for task 1
# model trained for 100 epochs for task 2
...
r3d34_1 = generate_model(34, n_classes=700)
PATH = 'r3d34_K_200ep.pth'
# PATH = '/content/drive/MyDrive/curated_data/r3d34_K_200ep.pth'

# Model class must be defined somewhere
r3d34_1.load_state_dict(torch.load(PATH)['state_dict'])
r3d34_1.eval()
r3d34_1 = r3d34_1.to(device)

# so we're doing feature extraction
for p in r3d34_1.parameters():
...
print('Model outputs for b_r3d34_1:')
...
# Model class must be defined somewhere
r3d34_2.load_state_dict(torch.load(PATH)['state_dict'])
r3d34_2.eval()
r3d34_2 = r3d34_2.to(device)

# think below we comment out
# # so we're doing feature extraction
# for p in r3d34_2.parameters():
#     p.requires_grad = False
#
# # change to classify for 2 classes
# r3d34_2.fc = nn.Linear(r3d34_2.fc.in_features, 2).to(device) # 2 classes
...
#
# print('Model outputs for b_r3d34_2:')
#
# # get precision, recall, f1-score
# print(classification_report(true, pred, target_names=target_names, digits=4))
#
...
#
# # Colab path commented out
# # torch.save(r3d34_2.state_dict(), 'drive/MyDrive/curated_data/baseline_r3d34_v0_test_2epoch.pth')
# torch.save(r3d34_2.state_dict(), 'b_r3d34_2.pth')
#
...
print('Model outputs for b_r3d34_T:')
