...
class CTDataset(data.Dataset):
    def __init__(self, data_home="",
        ...
        meta_non_pneum   = [[os.path.join(data_home, "NpyData-size224x336-test2", "{}.npy".format(x)), 0]
...
model.load_state_dict(torch.load('experiments_v4_dcvnt_pnm_run2/ncov-Epoch_00085.pth'))
...
SNAPSHOT_FREQ = 5
TRAIN_EPOCH = 116 #, will likely stop it early
SNAPSHOT_HOME = "experiments_v4_dcvnt_pnm_run2_r85"
