...
model.load_state_dict(torch.load('experiments_v4_dcvnt_inf_run2_r50/ncov-Epoch_00075.pth'))
...
SNAPSHOT_FREQ = 5
TRAIN_EPOCH = 126 #, will likely stop it early
SNAPSHOT_HOME = "experiments_v4_dcvnt_inf_run2_r75"
