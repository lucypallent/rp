...
class test_dataset2:
    def __init__(self, image_root, testsize):
        ...
        self.images = ['unet-results/' + x + '.npy' for x in self.pe_list]
...
save_path = 'dataset4/NCOV-BF/NpyData-infmask-test-1halfpc/'
model = Inf_Net()
...
for i in range(test_loader.size):
    ...
    for i, img in enumerate(images): # ([64, 1, 3, 352, 352])
        ...
        print(res)
        res1 = (np.ceil(res-0.015)).astype(np.float32) # currently swapped the two lines
    ...
    np.save(os.path.join(save_path + name3), res3)
...
des_home = 'dataset4/NCOV-BF/NpyData-infmask-test-1halfpc' # '/content/test'
...
src_home = 'dataset4/NCOV-BF/NpyData-infmask-test-1halfpc'
des_home = 'dataset4/NCOV-BF/NpyData-size224x336-infmask1010-test-1halfpc'
