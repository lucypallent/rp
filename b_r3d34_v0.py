...
for p in r3d34.parameters():
    p.requires_grad = False

# change to classify for 3 features
r3d34.fc = nn.Linear(r3d34.fc.in_features, 3).to(device) # 3 classes
...
optimizer = optim.SGD(r3d34.parameters(), lr=0.001, momentum=0.9)
...
print('Model outputs for b_r3d34_v0:')
...
torch.save(r3d34.state_dict(), 'b_r3d34_v0.pth')
