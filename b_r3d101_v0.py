# generate r3d101 based on here https://github.com/kenshohara/3D-ResNets-PyTorch/blob/master/models/resnet.py
import math
...
r3d101 = generate_model(101, n_classes=700)
PATH = 'r3d101_K_200ep.pth'
# PATH = '/content/drive/MyDrive/curated_data/r3d101_K_200ep.pth'

# Model class must be defined somewhere
r3d101.load_state_dict(torch.load(PATH)['state_dict'])
r3d101.eval()
r3d101 = r3d101.to(device)

# so we're doing feature extraction
for p in r3d101.parameters():
    p.requires_grad = False

# change to classify for 3 features
r3d101.fc = nn.Linear(r3d101.fc.in_features, 3).to(device) # 3 classes
...
optimizer = optim.SGD(r3d101.parameters(), lr=0.001, momentum=0.9)
...
print('Model outputs for b_r3d101_v0:')
...
# torch.save(r3d101.state_dict(), 'drive/MyDrive/curated_data/baseline_r3d101_v0_test_2epoch.pth')
torch.save(r3d101.state_dict(), 'b_r3d101_v0.pth')
