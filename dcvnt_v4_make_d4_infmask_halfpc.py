...
save_path = 'dataset4/NCOV-BF/NpyData-infmask-test-halfpc/'
model = Inf_Net()
...
for i in range(test_loader.size):
    ...
    for i, img in enumerate(images): # ([64, 1, 3, 352, 352])
        ...
        print(res)
        res1 = (np.ceil(res-0.005)).astype(np.float32) # currently swapped the two lines
...
des_home = 'dataset4/NCOV-BF/NpyData-infmask-test-halfpc' # '/content/test'
...
src_home = 'dataset4/NCOV-BF/NpyData-infmask-test-halfpc'
des_home = 'dataset4/NCOV-BF/NpyData-size224x336-infmask1010-test-halfpc'
